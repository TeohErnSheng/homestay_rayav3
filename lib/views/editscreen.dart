...
class _EditScreenState extends State<EditScreen> {
  ...
  final TextEditingController _hsfacilityEditingController =
      TextEditingController();
  final TextEditingController _hscontactNumberEditingController =
      TextEditingController();
  ...
  void initState() {
    ...
    _hscontactNumberEditingController.text =
        widget.homestay.contactNumber.toString();
            ...
            Padding(
              ...
              child: Form(
                ...
                child: Column(children: [
                  ...
                  TextFormField(
                      textInputAction: TextInputAction.next,
                      controller: _hscontactNumberEditingController,
                      validator: (val) => val!.isEmpty || (val.length < 10)
  ...
  void _updateProduct() {
    ...
    String contactNumber = _hscontactNumberEditingController.text;
    String price = _hspriceEditingController.text;
    String pax = _hspaxEditingController.text;

    http.post(
        Uri.parse(
            "${ServerConfig.server}/homestay_raya/php/update_homestay.php"),
        body: {
